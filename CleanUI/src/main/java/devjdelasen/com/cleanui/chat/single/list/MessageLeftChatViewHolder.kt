...
class MessageLeftChatViewHolder(itemView: View, onItemClickListener: OnChatMessageItemClickListener) :
    MessageChatViewHolderAbstract(itemView, onItemClickListener) {
